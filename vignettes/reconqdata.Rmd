---
title: "Academic Collaboration via Resource Contributions^[Authors thank (Polish) National Science Centre for support through SONATA grant 2012/07/D/HS6/01971 for the project Dynamics of Competition and Collaboration in Science: Individual Strategies, Collaboration Networks, and Organizational Hierarchies (http://recon.icm.edu.pl).]"
...
```{r corkboard, fig.cap="Using coekboard, pins, and rubber bands to collect data on collaborations."}
